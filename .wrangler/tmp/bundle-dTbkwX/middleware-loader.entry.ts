...
import worker from "/workspaces/ovia-home/.wrangler/tmp/bundle-dTbkwX/middleware-insertion-facade.js";
import {
	__facade_invoke__,
	__facade_register__,
	Dispatcher,
	Middleware,
} from "/workspaces/ovia-home/node_modules/wrangler/templates/middleware/common.ts";

// We need to preserve all of the exports from the worker
export * from "/workspaces/ovia-home/.wrangler/tmp/bundle-dTbkwX/middleware-insertion-facade.js";
